...
public class Admin extends User implements iMenu {
    ...
    public static String adminusername = "admin135";
    public static String adminpassword = "admin135";

    @Override
    public void menu() {
        Stage adminMenuStage = new Stage();
        adminMenuStage.setTitle("PERPUSTAKAAN UMM - Admin Menu");
    ...
    public void addstudent() {
        ...
        Label sumbitFailed = new Label("NIM Harus Lengkap");
    ...
    public void displaystudent() {
        ...
        displayStudentStage.setTitle("PERPUSTAKAAN UMM - Daftar Mahasiswa");
    ...
    public void displayBook() {
        ...
        displayBookStage.setTitle("PERPUSTAKAAN UMM - Daftar Buku yang Tersedia");
